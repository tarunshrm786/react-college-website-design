...
//           sx={{ marginTop: "20px", textAlign: "justify" }}
//         >
//           Through design education NAD endeavours to empower students with the knowledge, skills, values and attitudes to address the many interconnected global challenges faced today. Climate change, environmental degradation, loss of biodiversity, poverty and inequality. Thus, our theme for 2022 is: “SUSTAINABLE PRACTICES FOR A SHARED FUTURE”.
//         </Typography>
...
//           sx={{ marginTop: "20px", textAlign: "justify" }}
//         >
//           NAD’s DESIGN CULTURE initiative was inspired by the need to harness the power of Design to enable the aspirants of the creative and innovative domain to become Explorers, Creators, Changemakers and Leaders; Learners who are on a journey to understand themselves and the world at a deeper level, experiencing learning as a voyage of adventure and discovery; Self- directed practitioners who yearn to grow their creative capacity and love the discipline of expanding their abilities to solve complex global issues; Changemakers who extend the creative realm and focus on business and applied technology, keeping Circular Design at the epicentre; and quality human beings who are team nurturers; passionate, receptive, conﬁdent, and socially inclusive.
//         </Typography>

//         <Typography
//           variant="body1"
//           sx={{ marginTop: "20px", textAlign: "justify", fontWeight: "bold" }}
//         >
